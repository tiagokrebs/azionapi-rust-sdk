...
pub async fn get_resources(configuration: &configuration::Configuration, service_id: i64, page: Option<i64>, page_size: Option<i64>, filter: Option<&str>, order_by: Option<&str>, sort: Option<&str>) -> Result<serde_json::Value, Error<GetResourcesError>> {
    let local_var_configuration = configuration;
