...
pub async fn get_domains(configuration: &configuration::Configuration, accept: Option<&str>) -> Result<crate::models::DomainResponseWithResults, Error<GetDomainsError>> {
    let local_var_configuration = configuration;
