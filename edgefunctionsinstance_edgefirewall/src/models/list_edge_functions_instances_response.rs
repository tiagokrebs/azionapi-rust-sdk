...
pub struct ListEdgeFunctionsInstancesResponse {
    ...
    pub results: Option<Vec<crate::models::EdgeFunctionsInstance>>,
}

impl ListEdgeFunctionsInstancesResponse {
    pub fn new() -> ListEdgeFunctionsInstancesResponse {
