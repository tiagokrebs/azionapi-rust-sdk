...
> models::RulesEngineResponse edge_applications_edge_application_id_rules_engine_phase_rules_get(edge_application_id, phase, page, page_size, filter, order_by, sort, accept)
...
[**models::RulesEngineResponse**](RulesEngineResponse.md)
...
> models::RulesEngineIdResponse edge_applications_edge_application_id_rules_engine_phase_rules_post(edge_application_id, phase, accept, content_type, create_rules_engine_request)
/edge_applications/{edge_application_id}/rules_engine/{phase}/rules
...
[**models::RulesEngineIdResponse**](RulesEngineIdResponse.md)
...
> models::RulesEngineIdResponse edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_get(edge_application_id, phase, rule_id, accept)
/edge_applications/{edge_application_id}/rules_engine/{phase}/rules
...
> models::RulesEngineIdResponse edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_patch(edge_application_id, phase, rule_id, accept, content_type, patch_rules_engine_request)
...
> models::RulesEngineIdResponse edge_applications_edge_application_id_rules_engine_phase_rules_rule_id_put(edge_application_id, phase, rule_id, accept, content_type, update_rules_engine_request)
/edge_applications/:edge_application_id:/rules_engine/:phase:/rules/:rule_id:
