...
pub struct ApplicationResultsCreate {
    #[serde(rename = "id")]
    pub id: i64,
    #[serde(rename = "name")]
    pub name: String,
...
impl ApplicationResultsCreate {
    pub fn new(id: i64, name: String, active: bool, delivery_protocol: String, http_port: crate::models::InterfaceLeftCurlyBracketRightCurlyBracket, https_port: crate::models::InterfaceLeftCurlyBracketRightCurlyBracket, minimum_tls_version: String, application_acceleration: bool, caching: bool, device_detection: bool, edge_firewall: bool, edge_functions: bool, image_optimization: bool, load_balancer: bool, raw_logs: bool, web_application_firewall: bool) -> ApplicationResultsCreate {
